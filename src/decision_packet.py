    ...
    (packet_dir / "meeting_brief.md").write_text(
        "\n".join(
            [
                ...
                "",
                safe_read_text(review_packet_dir / "change_summary.md"),
                "",
                safe_read_text(project_dir / "analysis" / "open_questions.md"),
                "",
                safe_read_text(project_dir / "analysis" / "action_plan.md"),
                "",
